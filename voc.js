...
const EvRevoEuro = [
  "Règne de Louis XVI – Crise financière et contestation sociale.",
  "Début de la Révolution française – États généraux, fin de l’absolutisme.",
  "Serment du Jeu de Paume – naissance de l’Assemblée nationale.",
  "Prise de la Bastille – symbole de la fin de la monarchie absolue.",
  "Abolition des privilèges – égalité juridique entre citoyens.",
  "Déclaration des Droits de l’Homme et du Citoyen – libertés et égalité.",
  "Constitution de 1791 – monarchie constitutionnelle.",
  "Fuite du roi à Varennes – rupture entre le peuple et le roi.",
  "Déclaration de guerre à l’Autriche – européanisation de la Révolution.",
  "Prise des Tuileries – chute définitive de la monarchie.",
  "Proclamation de la République – abolition de la royauté.",
  "Exécution de Louis XVI – radicalisation de la Révolution.",
  "La Terreur – gouvernement de Robespierre, répression violente.",
  "Chute de Robespierre – fin de la Terreur, Directoire instauré.",
  "Coup d’État du 18 Brumaire – Napoléon prend le pouvoir.",
  "Code civil – unification du droit, égalité civile, stabilité sociale.",
  "Chute de Napoléon et Congrès de Vienne – restauration des monarchies.",
  "Sainte Alliance – coalition monarchique pour défendre l’ordre établi.",
  "Règne de Charles X – tensions politiques et sociales.",
  "Révolution de Juillet – chute de Charles X, avènement de Louis-Philippe.",
  "Révolutions de 1848 – Printemps des peuples, revendications nationales et libérales."
];
